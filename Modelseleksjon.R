...
bbmle::ICtab(m9g,m3a,m3b,m3c, m3d,m3e,m3f, type="AICc", logLik = T) 

### Sos Demografi
m4a <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + Alder, mydata, Hess =T) 
m4b <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + Kjønn, mydata, Hess =T)
m4c <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning, mydata, Hess =T) # bedre
bbmle::ICtab(m3c,m4b,m4c, type="AICc", logLik = T) 

m4d <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning + Alder, mydata, Hess =T) # Bedre
bbmle::ICtab(m4c,m4d, type="AICc", logLik = T) 

### Jakttradisjoner  
m5a <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning + Alder + q2_10 , mydata, Hess =T)
m5b <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning + Alder + q2_11.1 , mydata, Hess =T) # Bedre
...
m6a <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning + Alder + + q2_11.1 + q2_6.5, mydata, Hess =T)
m6b <- polr(q4_10~ q4_3 + q4_2 + q4_7 + ArtTilstede + q3_3_8 + q8_1Utdanning + Alder + + q2_11.1 + q2_7.5, mydata, Hess =T) # Bedre
